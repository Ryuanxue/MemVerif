...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
 {
	...
	if (loop/1000==0)
	{
		if (size>=196)
		{
		arg1=(struct test*)&data[0];
		arg1->str1=(char**)&data[32];
		*(arg1->str1) = (char*)&data[40];
		char* str1__=*(arg1->str1);
		arg1->str2=(char*)&data[40];
		arg1->stu=(struct subtest*)&data[104];
		arg2=(int*)&data[192];
		uint8_t *_point_0=&copydata[120];
		long *_point_to_0=(long*)_point_0;
		*_point_to_0=(long)&copydata[128];
